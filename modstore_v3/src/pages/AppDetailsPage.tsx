...
import { FiDownload, FiStar, FiArrowLeft, FiInfo, FiCheck, FiServer, FiClock, FiPackage, FiTag, FiCode, FiVideo } from 'react-icons/fi';
...
const AppDetailsPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'description' | 'features' | 'reviews' | 'videos' | 'download'>('description');
      ...
      <section className="py-8 bg-dark-500">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            {activeTab === 'videos' && (
              <div>
                <div className="bg-dark-600 p-6 rounded-xl mb-6">
                  <h3 className="text-white font-medium mb-4 flex items-center">
                    <FiVideo className="text-primary-400 mr-2" />
                    Gameplay Videos
                  </h3>
                  <p className="text-gray-300 mb-6">
                    Watch gameplay videos to see the modded features in action. These videos showcase the enhanced experience you'll get with our modded version of {app.name}.
                  </p>
                  <GameplayVideos app={app} autoplay={true} />
                  <div className="mt-6 pt-4 border-t border-dark-400">
                    <Link
                      to={`/gameplay-videos/${app.id}`}
                      className="text-primary-400 hover:text-primary-300 flex items-center"
                    >
                      <span>View all {app.name} gameplay videos</span>

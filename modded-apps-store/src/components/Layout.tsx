...
import { FiSearch, FiHome, FiGrid, FiDownload, FiStar } from 'react-icons/fi';
    ...
    <div className="flex flex-col min-h-screen bg-dark-500">
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center">
            <span className="text-white font-display text-2xl font-bold">
              Mod<span className="text-primary-500">Store</span>
            </span>
          </Link>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm">
                  <li><Link to="/categories/entertainment" className="hover:text-primary-300 transition-colors">Entertainment</Link></li>
                  <li><Link to="/categories/social" className="hover:text-primary-300 transition-colors">Social</Link></li>
                  <li><Link to="/categories/productivity" className="hover:text-primary-300 transition-colors">Productivity</Link></li>
                  <li><Link to="/categories/games" className="hover:text-primary-300 transition-colors">Games</Link></li>
                </ul>
              </div>
              <div className="space-y-3">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-dark-600 border-t border-dark-400 py-2 px-4 z-40">
        <div className="flex justify-around">
          <Link to="/" className={`flex flex-col items-center p-2 ${location.pathname === '/' ? 'text-primary-500' : 'text-gray-400'}`}>
            <FiHome className="text-xl" />
            <span className="text-xs mt-1">Home</span>
          </Link>
          <Link to="/categories/all" className={`flex flex-col items-center p-2 ${location.pathname.includes('/categories') ? 'text-primary-500' : 'text-gray-400'}`}>
            <FiGrid className="text-xl" />
            <span className="text-xs mt-1">Categories</span>
          </Link>
          <Link to="/search" className={`flex flex-col items-center p-2 ${location.pathname === '/search' ? 'text-primary-500' : 'text-gray-400'}`}>
            <FiSearch className="text-xl" />
            <span className="text-xs mt-1">Search</span>
          </Link>
          <Link to="/categories/trending" className={`flex flex-col items-center p-2 ${location.pathname.includes('/trending') ? 'text-primary-500' : 'text-gray-400'}`}>
